...
Systém bude schopný evidovať fľase s rôznymi plynmi, spoločne s podrobnejšími informáciami o fľašiach ako sú typ plynu, miesto uskladnenia, aktuálna poloha a podobne. Pri každej fľaši bude aj priestor na pridávanie komentáru ku danej fľaši.
Systém musí byť schopný zachovať históriu fľiaš, či už vyradených alebo stále v obehu. Systém bude implementovaný ako webové rozhranie. Pridávanie nových fľiaš je zabezpečené pomocou čiarových 
kódov ktorými disponuje každá fľaša. Všetky vlastnosti fľiaš budú editovateľné použítaveľmi. Systém bude mať rôznych použivateľov s rôznymi oprávaneniami so zásahom do údajov. Systém bude optimalizovaný pre mobilné aj pre desktop. Systém bude disponovať aj anglickou verziou webového rozhrania. Dáta v systéme bude použivateľ schopný aj filtrovať
pomocou predom nastavených filtrov alebo vyhľadávacieho poľa. Tlak vo fľašiach bude pridávaní pomocou odfotenia nanometra stavu nanometra používateľom. Pri prípadnej zlej detekcii stavu nanometra bude údaj mať možnosť upravenia. Všetky údaje budú automaticky ukladané systémom.
