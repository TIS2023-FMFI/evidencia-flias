...
Má všetky možnosti ako \ref{gen:users:operator}. Navyše môže pridávať a upravovať používateľov v systéme a upravovať nastavenia systému.
...
\begin{enumerate}
	...
	\item či je fľaša aktuálne pripojená (áno/nie)
...
\item Čitateľ môže exportovať zoznam fliaš a ich údaje.
...
\item Čitateľ si môže pozerať históriu zmien parametrov konkrétnej fľaše aj s autorom danej zmeny.
...
\item Editor môže svoje zmeny zvrátiť v rámci jedného dňa.
\item Operátor môže zvrátiť ľubovoľné vykonané zmeny.
\end{enumerate}
